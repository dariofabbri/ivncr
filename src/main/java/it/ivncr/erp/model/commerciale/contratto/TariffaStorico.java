...
@Entity
@Table(name = "con_tariffa_storico")
public class TariffaStorico implements Serializable {

  private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "con_tariffa_storico_id_seq")
	@SequenceGenerator(name = "con_tariffa_storico_id_seq", sequenceName = "con_tariffa_storico_id_seq")
	@Column(name="id")
	private Integer id;
