...
@Entity
@Table(name = "per_tipo_certificato")
public class TipoCertificato {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "per_tipo_certificato_id_seq")
	@SequenceGenerator(name = "per_tipo_certificato_id_seq", sequenceName = "per_tipo_certificato_id_seq")
	@Column(name="id")
	private Integer id;
