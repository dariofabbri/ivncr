...
@ManagedBean
@ViewScoped
public class DettaglioContrattoOds implements Serializable {

	private static final Logger logger = LoggerFactory.getLogger(DettaglioContrattoOds.class);
	...
	public DettaglioContrattoOds() {
		...
		model = new RobustLazyDataModel<OrdineServizio>() {
			...
			public List<OrdineServizio> load(
				...
				//
				filters.put("oneroso", Boolean.toString(false));
	...
	public String startCreate() {
		...
		return "/faces/commerciale/ods/detail?faces-redirect=true&oneroso=false&codiceTipoOrdineServizio=" +
